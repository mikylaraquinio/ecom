                                        ...
                                        @foreach($orders as $order)
                                            ...
                                            <td>
                                                ...
                                                @elseif($order->status == 'cancel_requested')
                                                    <form action="{{ route('seller.approveCancel', $order->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="btn btn-danger btn-sm">Approve Cancelation</button>
                                                    </form>
                                                    <form action="{{ route('seller.denyCancel', $order->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="btn btn-success btn-sm">Deny Cancelation</button>
                                                    </form>
                                                @endif
                                                </td>
                                            </tr>
