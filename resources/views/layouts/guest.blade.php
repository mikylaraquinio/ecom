...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="font-sans antialiased">
          ...
          <div class="row gy-4">
            ...
            <div class="col-md-3">
              ...
              <p class="small text-light">
                Empowering farmers with tools and knowledge to cultivate success. 
                Join the smart farming movement and connect directly with consumers.
              </p>
            </div>
            ...
            <!-- Support -->
            <div class="col-md-3">
              <h6 class="fw-semibold mb-3 text-uppercase">Support</h6>
              <ul class="list-unstyled small">
    ...
    <style>
      ...
      /* Footer styling (copied from app layout) */
      .footer {
