    ...
    @forelse($products as $product)
      ...
      <div class="col d-flex position-relative" style="overflow: visible;">
        ...
        <div class="position-absolute top-0 end-0 p-2 z-3" style="z-index: 10;">
          @auth
            <button
              class="btn btn-sm btn-outline-danger border-0 p-1 wishlist-btn"
...
<style>
  ...
  .product-box img { object-fit: cover; }
  .btn-outline-success { font-size: 13px; padding: 6px 12px; }
  .wishlist-btn:hover i, .btn-outline-secondary:hover i { color: #e3342f; }
  .badge.bg-success { background-color: #28a745 !important; font-size: 10px; padding: 4px 6px; border-radius: 4px; }
  .product-box h6 { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%; }
</style>
